    ...
    "data" : {
      ...
      "failure" : {
        ...
        "errors": [
          {
            "type" : "InvalidValue",
            "key" : "collector_tstamp",
            "value" : "29th May 2013 18:04:12",
            "message" : "Cannot parse key 'collector_tstamp with value 29th May 2013 18:04:12 into datetime"
          },
          {
            "type" : "InvalidValue",
            "key" : "event_id",
            "value" : "not-a-uuid",
            "message" : "Cannot parse key 'event_id with value not-a-uuid into UUID"
          }
        ]
      },
