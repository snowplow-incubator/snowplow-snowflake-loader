          ...
          "errors" : [
            {
              ...
              "key" : "contexts",
              "value" : "&&&",
              "message" : "ParsingFailure: expected json value got '&&&' (line 1, column 1)"
            },
            {
              "type" : "InvalidValue",
              "key" : "unstruct_event",
