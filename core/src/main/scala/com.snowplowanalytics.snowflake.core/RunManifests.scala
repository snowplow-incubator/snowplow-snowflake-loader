...
/**
  ...
  * Ported from Scala Analytics SDK 1.0.0
  *
...
object RunManifests {
  ...
  def addToManifests(dynamodb: AmazonDynamoDB, tableName: String, runId: String): Unit = {
    ...
    val _ = dynamodb.putItem(request)
  }
  ...
  private def waitForActive(client: AmazonDynamoDB, name: String): Unit = {
    val _ = new Table(client, name).waitForActive()
  }
  ...
  /**
    ...
    */
  private[core] def splitFullPath(fullS3Path: String): Either[String, (String, Option[String])] = {
  ...
  /**
    ...
    */
  private[core] def stripPrefix(path: String): Either[String, String] = {
