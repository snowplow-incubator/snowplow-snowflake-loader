...
object Cli {
  ...
  val appName = Opts.option[String]("app-name", "Optionally overrides the value of the application property in the JDBC connection, which is used internally by Snowflake").withDefault("Snowplow_OSS")
